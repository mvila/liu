...
class ChildCollection : public Iterable {
    LIU_DECLARE_2(ChildCollection, Object, Object);
public:
    explicit ChildCollection(Node *origin = context()->child("Object", "ChildCollection")) :
...
public:
    ...
    public:
        explicit Iterator(Node *origin = context()->child("Object", "ChildCollection", "Iterator")) :
