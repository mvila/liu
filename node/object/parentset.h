#ifndef LIU_PARENT_SET_H
#define LIU_PARENT_SET_H
...
class ParentSet : public Iterable {
    LIU_DECLARE_2(ParentSet, Object, Object);
public:
    explicit ParentSet(Node *origin = context()->child("Object", "ParentSet")) :
