#ifndef LIU_OLD_DICTIONARY_H
#define LIU_OLD_DICTIONARY_H
...
#define LIU_OLD_DICTIONARY(ARGS...) new OldDictionary(context()->child("Object", "OldDictionary"), ##ARGS)

class OldDictionary : public GenericDictionary<Node::Reference, Node *> {
    LIU_DECLARE(OldDictionary, Object, Object);
public:
    explicit OldDictionary(Node *origin) :
        GenericDictionary<Node::Reference, Node *>(origin) {}

    LIU_DECLARE_AND_DEFINE_COPY_METHOD(OldDictionary);
    LIU_DECLARE_AND_DEFINE_FORK_METHOD(OldDictionary);
