#ifndef LIU_LANGUAGE_MESSAGE_H
#define LIU_LANGUAGE_MESSAGE_H
...
namespace Language {
    ...
    (new Language::Message(context()->child("Object", "Language", "Message"), ##ARGS))

    class Message : public Object {
        LIU_DECLARE(Message, Object, Language);
    public:
