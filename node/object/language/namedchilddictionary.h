...
namespace Language {
    class NamedChildDictionary : public Indexable {
        LIU_DECLARE_2(NamedChildDictionary, Object, Language);
    public:
        explicit NamedChildDictionary(Node *origin = context()->child("Object", "Language", "NamedChildDictionary")) :
    ...
    public:
        ...
        public:
            ...
            explicit Iterator(Node *origin = context()->child("Object", "Language", "NamedChildDictionary", "Iterator")) :
