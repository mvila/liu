...
namespace Language {
    LIU_DEFINE_2(ChildCollection, Object, Language);
    ...
    void ChildCollection::Iterator::initRoot() {
        setSource(Node::root());
        setNamedChildIterator(NamedChildDictionary::Iterator::root());
        setUnnamedChildIterator(UnnamedChildCollection::Iterator::root());
