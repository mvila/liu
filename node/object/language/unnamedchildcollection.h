...
namespace Language {
    class UnnamedChildCollection : public Iterable {
        LIU_DECLARE_2(UnnamedChildCollection, Object, Language);
    public:
        explicit UnnamedChildCollection(Node *origin = context()->child("Object", "Language", "UnnamedChildCollection")) :
    ...
    public:
        ...
        public:
            explicit Iterator(Node *origin = context()->child("Object", "Language", "UnnamedChildCollection", "Iterator")) :
